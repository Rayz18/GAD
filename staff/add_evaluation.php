...
<body class="bg-light d-flex justify-content-center align-items-center min-vh-100">
    ...
    <div class="bg-white p-4 rounded shadow-lg w-100" style="max-width: 500px;">
        <h2 class="text-center h4 mb-4">Evaluation Form</h2>
        ...
        <form class="space-y-4">
            ...
            <div class="text-center mt-4">
                <button type="submit" class="btn btn-primary w-100">UPDATE EVALUATION FORM</button>
            </div>
        </form>
    </div>
    ...
    <script>
        function toggleChoicesSection() {
            ...
            // Show the choices section only for Dropdown and Radio field types
