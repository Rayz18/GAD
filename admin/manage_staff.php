                        ...
                        <tbody>
                            <?php while ($staff = $staff_accounts_query->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_staff.php?staff_id=<?php echo $staff['staff_id']; ?>" class="btn btn-sm btn-info edit">Edit</a>
                                        <a href="delete_staff.php?staff_id=<?php echo $staff['staff_id']; ?>" class="btn btn-sm btn-danger delete">Delete</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
