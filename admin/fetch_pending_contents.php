...
$image_columns = ['program_img', 'image_path', 'infographic_path', 'material_path', 'course_img', 'material_path', 'poster_path', 'campaign_image'];
                                ...
                                <?php foreach ($columns as $column): ?>
                                    <td>
                                        ...
                                        if (in_array(strtolower($column), $image_columns) && !empty($row[$column])): ?>
                                            <img src="../staff/upload/images/<?php echo htmlspecialchars($row[$column]); ?>" alt="Image"
