                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        <td class="post-question-text"><?php echo htmlspecialchars($row['question_text']); ?></td>
                                        <td class="text-center">
                                            <span class="post-answer-badge"><?php echo strtoupper(htmlspecialchars($row['correct_option'])); ?></span>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
